...
class ClevelandResponseTest {
    ...
    fun extractDimensionsShouldReturnExpectedValuesAreThree() {
        val dimensions = "35.5 x 62.5 x 2.7 cm (14 x 24 5/8 x 1 1/16 in.)".extractDimensions()
    ...
    fun extractDimensionsShouldReturnExpectedValuesWhenDimensionsAreTwo() {
        val dimensions = "Framed: 125.4 x 186.7 x 9.2 cm (49 3/8 x 73 1/2 x 3 5/8 in.); Unframed: 99.5 x 160.4 cm (39 3/16 x 63 1/8 in.)".extractDimensions()
